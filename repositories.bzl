...
def gapic_generator_php_repositories():
    ...
    maybe(
        ...
        name = "php_micro",
        prebuilt_phps = [
            "@gapic_generator_php//:rules_php_gapic/resources/php-8.1.8_linux_x86_64.tar.gz",
            "@gapic_generator_php//:rules_php_gapic/resources/php-8.1.8_darwin_amd64.tar.gz",
        ],
