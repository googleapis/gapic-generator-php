...
EOL;
    ...
    public function testRemoveNoCheckInHeaderWithProtobufMessage()
    {
        ...
        $classContents = file_get_contents($protobufMessage);

        // The checked-in gencode does not carry the header, so add it here. Without this the
        // post-condition below holds no matter what removeNoCheckInHeader() does.
        $classContents = str_replace(
            "# Generated by the protocol buffer compiler.  DO NOT EDIT!\n",
            "# Generated by the protocol buffer compiler.  DO NOT EDIT!\n# NO CHECKED-IN PROTOBUF GENCODE\n",
            $classContents
        );
        $this->assertTrue($this->classContainsNoCheckInHeader($classContents));

        $addFragmentUtil = new ProtobufNoCheckInHeaderProcessor($classContents);
