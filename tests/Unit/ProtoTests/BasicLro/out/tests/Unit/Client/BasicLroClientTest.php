...
namespace Testing\BasicLro\Tests\Unit\Client;
...
class BasicLroClientTest extends GeneratedTest
{
    ...
    public function method1Test()
    {
        ...
        $completeOperation->setName('operations/method1Test');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $request = new Request();
        $response = $gapicClient->method1($request);
        ...
        $this->assertSame('/testing.basiclro.BasicLro/Method1', $actualApiFuncCall);
    ...
    public function methodNonLro1Test()
    {
        ...
        $request = new Request();
        $response = $gapicClient->methodNonLro1($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/testing.basiclro.BasicLro/MethodNonLro1', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function methodNonLro1ExceptionTest()
    {
        ...
        $request = new Request();
        try {
            $gapicClient->methodNonLro1($request);
    ...
    public function methodNonLro2Test()
    {
        ...
        $transport->addResponse($expectedResponse);
        $request = new Request();
        $response = $gapicClient->methodNonLro2($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/testing.basiclro.BasicLro/MethodNonLro2', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function methodNonLro2ExceptionTest()
    {
        ...
        $request = new Request();
        try {
            $gapicClient->methodNonLro2($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
