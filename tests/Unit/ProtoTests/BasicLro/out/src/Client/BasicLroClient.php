 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/BasicLro/basic-lro.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Testing\BasicLro\Client;
 ...
 *
 * @method PromiseInterface<OperationResponse> method1Async(Request $request, array $optionalArgs = [])
...
final class BasicLroClient
{
     ...
     *           $options = new BasicLroClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see BasicLroClient::method1Async()} .
     *
     * @example samples/BasicLroClient/method1.php
     *
    ...
    /**
     * The async variant is {@see BasicLroClient::methodNonLro1Async()} .
     *
     * @example samples/BasicLroClient/method_non_lro1.php
     *
     * @param Request $request     A request to house fields associated with the call.
     * @param array   $callOptions {
     *     Optional.
    ...
    /**
     * The async variant is {@see BasicLroClient::methodNonLro2Async()} .
     *
     * @example samples/BasicLroClient/method_non_lro2.php
     *
     * @param Request $request     A request to house fields associated with the call.
     * @param array   $callOptions {
     *     Optional.
