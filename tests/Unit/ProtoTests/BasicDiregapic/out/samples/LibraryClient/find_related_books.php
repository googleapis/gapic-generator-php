 ...
 * @param string $formattedShelvesElement Please see {@see LibraryClient::shelfName()} for help formatting this field.
 */
...
{
    $formattedNamesElement = LibraryClient::bookName('[SHELF]', '[BOOK_ONE]', '[BOOK_TWO]');
    $formattedShelvesElement = LibraryClient::shelfName('[SHELF]');

    find_related_books_sample($formattedNamesElement, $formattedShelvesElement);
}
// [END example_generated_Library_FindRelatedBooks_sync]
