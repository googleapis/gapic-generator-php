 ...
 * Creates a book.
 *
 * @param string $formattedName     Parent shelf
 *                                  id. Please see {@see LibraryClient::shelfName()} for help formatting this field.
...
{
    $formattedName = LibraryClient::shelfName('[SHELF]');
    $formattedBookName = LibraryClient::bookName('[SHELF]', '[BOOK_ONE]', '[BOOK_TWO]');

    create_book_sample($formattedName, $formattedBookName);
}
// [END example_generated_Library_CreateBook_sync]
