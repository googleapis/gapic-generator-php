...
function publish_series_sample(
    ...
    try {
        ...
        $response = $libraryClient->publishSeries($shelf, $books, $seriesUuid, $genres);
...
{
    $shelfName = '[NAME]';
    $formattedBooksName = LibraryClient::bookName('[SHELF]', '[BOOK_ONE]', '[BOOK_TWO]');
    $genresElement = Genre::UNSET;

    publish_series_sample($shelfName, $formattedBooksName, $genresElement);
}
// [END example_generated_Library_PublishSeries_sync]
