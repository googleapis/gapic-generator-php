...
class LibraryGapicClient
{
     ...
     * try {
     *     $formattedNames = [
     *         $libraryClient->bookName('[SHELF]', '[BOOK_ONE]', '[BOOK_TWO]'),
     *     ];
     *     $formattedShelves = [
     *         $libraryClient->shelfName('[SHELF]'),
     *     ];
     *     // Iterate over pages of elements
     *     $pagedResponse = $libraryClient->findRelatedBooks($formattedNames, $formattedShelves);
     ...
     * try {
     *     $formattedName = $libraryClient->bookName('[SHELF]', '[BOOK_ONE]', '[BOOK_TWO]');
     *     $operationResponse = $libraryClient->getBigBook($formattedName);
     ...
     *     // ... do other work
     *     $newOperationResponse = $libraryClient->resumeOperation($operationName, 'getBigBook');
     ...
     * try {
     *     $formattedName = $libraryClient->bookName('[SHELF]', '[BOOK_ONE]', '[BOOK_TWO]');
     *     $operationResponse = $libraryClient->getBigNothing($formattedName);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $libraryClient->resumeOperation($operationName, 'getBigNothing');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     $response = $libraryClient->getBookFromAnywhere($formattedName, $formattedAltBookName, $formattedPlace, $formattedFolder);
     * } finally {
     *     $libraryClient->close();
     * }
     * ```
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $libraryClient->listAggregatedShelves();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     *     $formattedName = $libraryClient->shelfName('[SHELF]');
     *     // Iterate over pages of elements
     *     $pagedResponse = $libraryClient->listBooks($formattedName);
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $libraryClient->listStrings();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     * $libraryClient = new LibraryClient();
     * try {
     *     $operationResponse = $libraryClient->longRunningArchiveBooks();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *         // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $libraryClient->resumeOperation($operationName, 'longRunningArchiveBooks');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
