...
/**
 * Archive contains methods for building and parsing the
 * library.googleapis.com/Archive resource names.
 */
class Archive
{
     ...
     * resource using the archive.
     *
     * @param string $archive
     *
     * @return string The formatted Archive resource name.
     */
