...
/**
 * ArchivedBook contains methods for building and parsing the
 * library.googleapis.com/ArchivedBook resource names.
 */
class ArchivedBook
{
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a ArchivedBook
     * resource using the archive, and book.
     *
     * @param string $archive
     * @param string $book
     *
     * @return string The formatted ArchivedBook resource name.
     */
