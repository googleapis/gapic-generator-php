...
/**
 * Shelf contains methods for building and parsing the library.googleapis.com/Shelf
 * resource names.
 */
class Shelf
{
     ...
     * resource using the shelf.
     *
     * @param string $shelf
     *
     * @return string The formatted Shelf resource name.
     */
