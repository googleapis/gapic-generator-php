...
/**
 * Book contains methods for building and parsing the library.googleapis.com/Book
 * resource names.
 */
class Book
{
     ...
     * resource using the archive, and book.
     *
     * @param string $archive
     * @param string $book
     *
     * @return string The formatted Book resource name.
     */
    public static function fromArchiveBook($archive, $book)
    {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a Book
     * resource using the project, and book.
     *
     ...
     * @return string The formatted Book resource name.
     */
    public static function fromProjectBook($project, $book)
    {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a Book
     * resource using the project, location, publisher, and book.
     *
     * @param string $project
     ...
     * @return string The formatted Book resource name.
     */
    public static function fromProjectLocationPublisherBook($project, $location, $publisher, $book)
    {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a Book
     * resource using the shelf, book_one, and book_two.
     *
     * @param string $shelf
     ...
     * @return string The formatted Book resource name.
     */
    public static function fromShelfBookOneBookTwo($shelf, $bookOne, $bookTwo)
    {
