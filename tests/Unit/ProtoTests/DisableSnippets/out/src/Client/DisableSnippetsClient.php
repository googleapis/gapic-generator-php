 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/DisableSnippets/disable_snippets.proto
...
final class DisableSnippetsClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/disable_snippets_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           $options = new DisableSnippetsClient(['credentials' => $creds]);
     *           ```
     *           {@see
    ...
    /**
     * The async variant is {@see DisableSnippetsClient::method1Async()} .
     *
     * @example samples/DisableSnippetsClient/method1.php
     *
