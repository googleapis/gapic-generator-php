 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/BasicPaginated/basic-paginated.proto
...
class BasicPaginatedGapicClient
{
     ...
     */
    public function methodPaginated($aField, $pageToken, $partOfRequestA, array $callOptions = [])
    {
        $request = new Request();
        ...
        return $this->getPagedListResponse('MethodPaginated', $callOptions, Response::class, $request);
    }
}
