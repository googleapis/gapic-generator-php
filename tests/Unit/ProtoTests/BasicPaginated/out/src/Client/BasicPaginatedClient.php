...
namespace Testing\BasicPaginated\Client;
...
final class BasicPaginatedClient
{
     ...
     *           $options = new BasicPaginatedClient(['credentials' => $creds]);
     *           ```
     *           {@see
    ...
    /**
     * The async variant is {@see BasicPaginatedClient::methodPaginatedAsync()} .
     *
     * @example samples/BasicPaginatedClient/method_paginated.php
     *
