...
namespace Testing\BasicPaginated\Tests\Unit\Client;
...
class BasicPaginatedClientTest extends GeneratedTest
{
    ...
    public function methodPaginatedTest()
    {
        ...
        $response = $gapicClient->methodPaginated($request);
    ...
    public function methodPaginatedExceptionTest()
    {
        ...
        $request = (new Request())
            ...
            ->setPartOfRequestA($partOfRequestA);
        try {
            $gapicClient->methodPaginated($request);
    ...
    public function methodPaginatedAsyncTest()
    {
        ...
        $request = (new Request())
            ...
            ->setPageToken($pageToken)
            ->setPartOfRequestA($partOfRequestA);
        $response = $gapicClient->methodPaginatedAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getTheResults()[0], $resources[0]);
