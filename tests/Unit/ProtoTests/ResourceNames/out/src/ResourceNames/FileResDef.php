...
/**
 * FileResDef contains methods for building and parsing the
 * resourcenames.example.com/FileResDef resource names.
 */
class FileResDef
{
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a FileResDef
     * resource using the item1_id.
     *
     * @param string $item1Id
     *
     * @return string The formatted FileResDef resource name.
     */
