...
/**
 * FolderUnused contains methods for building and parsing the
 * resourcenames.example.com/FolderUnused resource names.
 */
class FolderUnused
{
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a FolderUnused
     * resource using the folder_id.
     *
     * @param string $folderId
     *
     * @return string The formatted FolderUnused resource name.
     */
