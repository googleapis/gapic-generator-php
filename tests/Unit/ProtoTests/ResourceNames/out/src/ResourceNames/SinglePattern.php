...
/**
 * SinglePattern contains methods for building and parsing the
 * resourcenames.example.com/SinglePattern resource names.
 */
class SinglePattern
{
     ...
     * SinglePattern resource using the item1_id, and item2_id.
     *
     * @param string $item1Id
     * @param string $item2Id
     *
     * @return string The formatted SinglePattern resource name.
     */
