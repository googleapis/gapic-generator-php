...
/**
 * WildcardMultiPattern contains methods for building and parsing the
 * resourcenames.example.com/WildcardMultiPattern resource names.
 */
class WildcardMultiPattern
{
     ...
     * WildcardMultiPattern resource using the item1_id.
     *
     * @param string $item1Id
     *
     * @return string The formatted WildcardMultiPattern resource name.
     */
    public static function fromItem1Id($item1Id)
    {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * WildcardMultiPattern resource using the item2_id.
     *
     * @param string $item2Id
     *
     * @return string The formatted WildcardMultiPattern resource name.
     */
    public static function fromItem2Id($item2Id)
    {
