...
/**
 * FileMulti contains methods for building and parsing the
 * resourcenames.example.com/FileMulti resource names.
 */
class FileMulti
{
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a FileMulti
     * resource using the folder1_id, and file_id.
     *
     * @param string $folder1Id
     * @param string $fileId
     *
     * @return string The formatted FileMulti resource name.
     */
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a FileMulti
     * resource using the folder2_id, and file_id.
     *
