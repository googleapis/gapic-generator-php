 ...
 */
final class CustomLroClient implements CustomLroClientInterface
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'testing.customlronew.CustomLro';
     ...
     *           use Testing\CustomLroNew\CustomLroClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomLroClient(['credentials' => $creds]);
     *           ```
     *           {@see
