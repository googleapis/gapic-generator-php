 ...
 */
final class CustomLroOperationsClient implements CustomLroOperationsClientInterface
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'testing.customlronew.CustomLroOperations';
     ...
     *           use Testing\CustomLroNew\CustomLroOperationsClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomLroOperationsClient(['credentials' => $creds]);
     *           ```
     *           {@see
