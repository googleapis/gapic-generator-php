...
namespace Testing\CustomLroNew\Tests\Unit\Client;
...
use Testing\CustomLroNew\CustomOperationResponse\Status;
use stdClass;
...
class CustomLroClientTest extends GeneratedTest
{
    ...
    public function createFooTest()
    {
        ...
        $request = (new CreateFooRequest())
            ->setProject($project)
            ->setRegion($region);
        $response = $gapicClient->createFoo($request);
        ...
        $this->assertSame('/testing.customlronew.CustomLro/CreateFoo', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
        $expectedOperationsRequestObject = new \Testing\CustomLroNew\GetOperationRequest();
        ...
        $this->assertSame('/testing.customlronew.CustomLroOperations/Get', $actualOperationsFuncCall);
    ...
    public function createFooAsyncTest()
    {
        ...
        // Mock response
        $incompleteOperation = new CustomOperationResponse();
        $incompleteOperation->setName('customOperations/createFooAsyncTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new CustomOperationResponse();
        $completeOperation->setName('customOperations/createFooAsyncTest');
        $completeOperation->setStatus(Status::DONE);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $project = 'project-309310695';
