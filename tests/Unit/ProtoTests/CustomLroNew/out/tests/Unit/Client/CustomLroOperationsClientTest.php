...
class CustomLroOperationsClientTest extends GeneratedTest
{
    ...
    public function cancelTest()
    {
        ...
        $this->assertSame('/testing.customlronew.CustomLroOperations/Cancel', $actualFuncCall);
    ...
    public function deleteTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/testing.customlronew.CustomLroOperations/Delete', $actualFuncCall);
        $actualValue = $actualRequestObject->getOperation();
        $this->assertProtobufEquals($operation, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getTest()
    {
        ...
        $foo = 'foo101574';
        $request = (new \Testing\CustomLroNew\GetOperationRequest())
            ->setOperation($operation)
            ->setProject($project)
            ->setRegion($region)
            ->setFoo($foo);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/testing.customlronew.CustomLroOperations/Get', $actualFuncCall);
        $actualValue = $actualRequestObject->getOperation();
        $this->assertProtobufEquals($operation, $actualValue);
