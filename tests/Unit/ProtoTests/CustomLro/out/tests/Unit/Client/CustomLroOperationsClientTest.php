...
namespace Testing\CustomLro\Tests\Unit\Client;
...
class CustomLroOperationsClientTest extends GeneratedTest
{
    ...
    public function cancelTest()
    {
        ...
        $this->assertSame('/testing.customlro.CustomLroOperations/Cancel', $actualFuncCall);
    ...
    public function deleteTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/testing.customlro.CustomLroOperations/Delete', $actualFuncCall);
        $actualValue = $actualRequestObject->getOperation();
        $this->assertProtobufEquals($operation, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getTest()
    {
        ...
        $foo = 'foo101574';
        $request = (new \Testing\CustomLro\GetOperationRequest())
            ->setOperation($operation)
            ->setProject($project)
            ->setRegion($region)
            ->setFoo($foo);
