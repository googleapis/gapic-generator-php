...
namespace Testing\GrpcServiceConfig\Tests\Unit\Client;
...
class GrpcServiceConfigWithRetry1ClientTest extends GeneratedTest
{
    ...
    public function method1ATest()
    {
        ...
        $response = $gapicClient->method1A($request);
    ...
    public function method1BLroTest()
    {
        ...
        $request = new Request1();
        $response = $gapicClient->method1BLro($request);
    ...
    public function method1CServiceLevelRetryTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $request = new Request1();
        $response = $gapicClient->method1CServiceLevelRetry($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function method1CServiceLevelRetryExceptionTest()
    {
        ...
        $request = new Request1();
        try {
            $gapicClient->method1CServiceLevelRetry($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function method1DTimeoutOnlyRetryTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $request = new Request1();
        $response = $gapicClient->method1DTimeoutOnlyRetry($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function method1DTimeoutOnlyRetryExceptionTest()
    {
        ...
        $request = new Request1();
        try {
            $gapicClient->method1DTimeoutOnlyRetry($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function method1ServerStreamingTest()
    {
        ...
        // Mock request
        $request = new Request1();
        $serverStream = $gapicClient->method1ServerStreaming($request);
