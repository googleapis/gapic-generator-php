...
namespace Testing\GrpcServiceConfig\Client;
 ...
 *
 * @method PromiseInterface<Response1> method1AAsync(Request1 $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> method1BLroAsync(Request1 $request, array $optionalArgs = [])
...
final class GrpcServiceConfigWithRetry1Client
{
     ...
     *           $options = new GrpcServiceConfigWithRetry1Client(['credentials' => $creds]);
     *           ```
     *           {@see
    ...
    /**
     * The async variant is {@see GrpcServiceConfigWithRetry1Client::method1AAsync()} .
     *
     * @example samples/GrpcServiceConfigWithRetry1Client/method1_a.php
     *
     ...
     * {@see GrpcServiceConfigWithRetry1Client::method1BLroAsync()} .
     *
     * @example samples/GrpcServiceConfigWithRetry1Client/method1_b_lro.php
     *
     * @param Request1 $request     A request to house fields associated with the call.
     * @param array    $callOptions {
     *     Optional.
     ...
     * }
     *
     * @return OperationResponse<LroResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    ...
    /**
     * @example samples/GrpcServiceConfigWithRetry1Client/method1_bidi_streaming.php
     *
     * @param array $callOptions {
     *     Optional.
     *
    ...
    /**
     * The async variant is
     * {@see GrpcServiceConfigWithRetry1Client::method1CServiceLevelRetryAsync()} .
     *
     * @example samples/GrpcServiceConfigWithRetry1Client/method1_c_service_level_retry.php
     *
     * @param Request1 $request     A request to house fields associated with the call.
     * @param array    $callOptions {
     *     Optional.
    ...
    /**
     * The async variant is
     * {@see GrpcServiceConfigWithRetry1Client::method1DTimeoutOnlyRetryAsync()} .
     *
     * @example samples/GrpcServiceConfigWithRetry1Client/method1_d_timeout_only_retry.php
     *
     * @param Request1 $request     A request to house fields associated with the call.
     * @param array    $callOptions {
     *     Optional.
    ...
    /**
     * @example samples/GrpcServiceConfigWithRetry1Client/method1_server_streaming.php
     *
     * @param Request1 $request     A request to house fields associated with the call.
     * @param array    $callOptions {
     *     Optional.
