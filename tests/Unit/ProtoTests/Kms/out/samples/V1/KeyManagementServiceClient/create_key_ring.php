 ...
 */
function create_key_ring_sample(string $parent, string $keyRingId)
{
    ...
    try {
        ...
        $response = $keyManagementServiceClient->createKeyRing($parent, $keyRingId, $keyRing);
...
function callSample()
{
    ...
    create_key_ring_sample($parent, $keyRingId);
}
