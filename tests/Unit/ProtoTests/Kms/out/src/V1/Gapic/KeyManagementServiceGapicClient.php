 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/Kms/service.proto
...
class KeyManagementServiceGapicClient
{
     ...
     *     $parent = 'parent';
     *     // Iterate over pages of elements
     *     $pagedResponse = $keyManagementServiceClient->listKeyRings($parent);
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
