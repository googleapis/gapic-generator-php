 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/DeprecatedService/deprecated_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Testing\Deprecated\Client;
...
final class DeprecatedServiceClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/deprecated_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/deprecated_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/deprecated_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/deprecated_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           $options = new DeprecatedServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see DeprecatedServiceClient::fastFibonacciAsync()} .
     *
     * @example samples/DeprecatedServiceClient/fast_fibonacci.php
     *
     ...
     *
     * The async variant is {@see DeprecatedServiceClient::slowFibonacciAsync()} .
     *
     * @example samples/DeprecatedServiceClient/slow_fibonacci.php
     *
     * @param FibonacciRequest $request     A request to house fields associated with the call.
     * @param array            $callOptions {
     *     Optional.
