...
namespace Testing\Deprecated\Tests\Unit\Client;
...
class DeprecatedServiceClientTest extends GeneratedTest
{
    ...
    public function fastFibonacciTest()
    {
        ...
        $gapicClient->fastFibonacci($request);
    ...
    public function slowFibonacciTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $request = new FibonacciRequest();
        $gapicClient->slowFibonacci($request);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/testing.deprecated_service.DeprecatedService/SlowFibonacci', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
