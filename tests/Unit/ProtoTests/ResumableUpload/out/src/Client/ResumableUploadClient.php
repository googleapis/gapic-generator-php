 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/ResumableUpload/resumable_upload.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Testing\Resumableupload\Client;
...
final class ResumableUploadClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/resumable_upload_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/resumable_upload_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/resumable_upload_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/resumable_upload_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           as "<uri>:<port>". Default 'resumableupload.example.com:443'.
     ...
     *           use Testing\Resumableupload\ResumableUploadClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ResumableUploadClient(['credentials' => $creds]);
     *           ```
     *           {@see
