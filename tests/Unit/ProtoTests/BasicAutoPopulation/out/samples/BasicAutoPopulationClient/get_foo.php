...
// [START autopopulation_generated_BasicAutoPopulation_GetFoo_sync]
...
function get_foo_sample(string $aField): void
{
    ...
    try {
        ...
        $response = $basicAutoPopulationClient->getFoo($request);
...
function callSample(): void
{
    ...
    get_foo_sample($aField);
}
// [END autopopulation_generated_BasicAutoPopulation_GetFoo_sync]
