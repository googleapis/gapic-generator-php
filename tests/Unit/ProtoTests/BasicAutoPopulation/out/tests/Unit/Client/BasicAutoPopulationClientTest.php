...
namespace Testing\BasicAutoPopulation\Tests\Unit\Client;
...
class BasicAutoPopulationClientTest extends GeneratedTest
{
    ...
    public function createFooTest()
    {
        ...
        $this->assertSame('/testing.basicautopopulation.BasicAutoPopulation/CreateFoo', $actualFuncCall);
    ...
    public function getFooTest()
    {
        ...
        $request = (new Request())
            ->setAField($aField);
        $response = $gapicClient->getFoo($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/testing.basicautopopulation.BasicAutoPopulation/GetFoo', $actualFuncCall);
        $actualValue = $actualRequestObject->getAField();
        $this->assertProtobufEquals($aField, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function createFooAsyncTest()
    {
        ...
        $request = (new Request())
            ->setAField($aField);
        $response = $gapicClient->createFooAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
