...
final class BasicAutoPopulationClient
{
     ...
     *           $options = new BasicAutoPopulationClient(['credentials' => $creds]);
     *           ```
     *           {@see
    ...
    /**
     * The async variant is {@see BasicAutoPopulationClient::createFooAsync()} .
     *
     * @example samples/BasicAutoPopulationClient/create_foo.php
     *
     ...
     */
    public function createFoo(Request $request, array $callOptions = []): Response
    {
        return $this->startApiCall('CreateFoo', $request, $callOptions)->wait();
    }

    /**
     * The async variant is {@see BasicAutoPopulationClient::getFooAsync()} .
     *
     * @example samples/BasicAutoPopulationClient/get_foo.php
     *
     * @param Request $request     A request to house fields associated with the call.
     * @param array   $callOptions {
     *     Optional.
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getFoo(Request $request, array $callOptions = []): Response
    {
        return $this->startApiCall('GetFoo', $request, $callOptions)->wait();
    }
}
