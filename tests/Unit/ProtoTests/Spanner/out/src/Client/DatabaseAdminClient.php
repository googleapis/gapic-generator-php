 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/Spanner/spanner_database_admin.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Spanner\Cloud\Database_v1\Client;
...
final class DatabaseAdminClient
{
    ...
    private const SERVICE_NAME = 'spanner.cloud.database_v1.DatabaseAdmin';
     ...
     *
     * The async variant is {@see DatabaseAdminClient::aMethodAsync()} .
     *
     * @example samples/DatabaseAdminClient/a_method.php
     *
