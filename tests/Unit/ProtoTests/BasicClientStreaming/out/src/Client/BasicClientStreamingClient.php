 ...
 * https://github.com/googleapis/googleapis/blob/master/tests/Unit/ProtoTests/BasicClientStreaming/basic-client-streaming.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Testing\BasicClientStreaming\Client;
 ...
 */
final class BasicClientStreamingClient
{
     ...
     *           $options = new BasicClientStreamingClient(['credentials' => $creds]);
     *           ```
     *           {@see
    ...
    /**
     * @example samples/BasicClientStreamingClient/method_client.php
     *
    ...
    /**
     * @example samples/BasicClientStreamingClient/method_empty.php
     *
     * @param array $callOptions {
     *     Optional.
     *
