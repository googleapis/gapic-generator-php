...
namespace Testing\BasicOneof\Client;
...
final class BasicOneofClient
{
     ...
     *           $options = new BasicOneofClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see BasicOneofClient::aMethodAsync()} .
     *
     * @example samples/BasicOneofClient/a_method.php
     *
