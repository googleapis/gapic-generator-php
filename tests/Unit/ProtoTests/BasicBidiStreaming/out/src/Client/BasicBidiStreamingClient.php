...
namespace Testing\BasicBidiStreaming\Client;
...
final class BasicBidiStreamingClient
{
     ...
     *           $options = new BasicBidiStreamingClient(['credentials' => $creds]);
     *           ```
     *           {@see
    ...
    /**
     * @example samples/BasicBidiStreamingClient/method_bidi.php
     *
    ...
    /**
     * @example samples/BasicBidiStreamingClient/method_empty.php
     *
     * @param array $callOptions {
     *     Optional.
     *
