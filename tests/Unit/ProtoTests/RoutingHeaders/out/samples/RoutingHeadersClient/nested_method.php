...
// [START routingheaders_generated_RoutingHeaders_NestedMethod_sync]
 ...
 */
function nested_method_sample(string $nest1Nest2Name, string $anotherName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $routingHeadersClient->nestedMethod($request);
...
function callSample(): void
{
    ...
    nested_method_sample($nest1Nest2Name, $anotherName);
}
// [END routingheaders_generated_RoutingHeaders_NestedMethod_sync]
