...
// [START routingheaders_generated_RoutingHeaders_PatchMethod_sync]
...
function patch_method_sample(): void
{
    ...
    try {
        ...
        $response = $routingHeadersClient->patchMethod($request);
        printf('Response data: %s' . PHP_EOL, $response->serializeToJsonString());
    } catch (ApiException $ex) {
        printf('Call failed with message: %s' . PHP_EOL, $ex->getMessage());
    }
}
// [END routingheaders_generated_RoutingHeaders_PatchMethod_sync]
