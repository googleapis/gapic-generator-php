...
class GenerativeQuestionServiceClientTest extends GeneratedTest
{
    ...
    public function batchUpdateGenerativeQuestionConfigsTest()
    {
        ...
        // Mock request
        $requests = [];
        $response = $gapicClient->batchUpdateGenerativeQuestionConfigs($requests);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.GenerativeQuestionService/BatchUpdateGenerativeQuestionConfigs', $actualFuncCall);
    ...
    public function batchUpdateGenerativeQuestionConfigsExceptionTest()
    {
        ...
        $requests = [];
        try {
            $gapicClient->batchUpdateGenerativeQuestionConfigs($requests);
    ...
    public function getGenerativeQuestionsFeatureConfigTest()
    {
        ...
        $response = $gapicClient->getGenerativeQuestionsFeatureConfig($formattedCatalog);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.GenerativeQuestionService/GetGenerativeQuestionsFeatureConfig', $actualFuncCall);
    ...
    public function getGenerativeQuestionsFeatureConfigExceptionTest()
    {
        ...
        $formattedCatalog = $gapicClient->catalogName('[PROJECT]', '[LOCATION]', '[CATALOG]');
        try {
            $gapicClient->getGenerativeQuestionsFeatureConfig($formattedCatalog);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listGenerativeQuestionConfigsTest()
    {
        ...
        $response = $gapicClient->listGenerativeQuestionConfigs($formattedParent);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.GenerativeQuestionService/ListGenerativeQuestionConfigs', $actualFuncCall);
    ...
    public function listGenerativeQuestionConfigsExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->catalogName('[PROJECT]', '[LOCATION]', '[CATALOG]');
        try {
            $gapicClient->listGenerativeQuestionConfigs($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateGenerativeQuestionConfigTest()
    {
        ...
        $response = $gapicClient->updateGenerativeQuestionConfig($generativeQuestionConfig);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.GenerativeQuestionService/UpdateGenerativeQuestionConfig', $actualFuncCall);
    ...
    public function updateGenerativeQuestionConfigExceptionTest()
    {
        ...
        $generativeQuestionConfig->setFacet($generativeQuestionConfigFacet);
        try {
            $gapicClient->updateGenerativeQuestionConfig($generativeQuestionConfig);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateGenerativeQuestionsFeatureConfigTest()
    {
        ...
        $response = $gapicClient->updateGenerativeQuestionsFeatureConfig($generativeQuestionsFeatureConfig);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.GenerativeQuestionService/UpdateGenerativeQuestionsFeatureConfig', $actualFuncCall);
    ...
    public function updateGenerativeQuestionsFeatureConfigExceptionTest()
    {
        ...
        $generativeQuestionsFeatureConfig->setCatalog($generativeQuestionsFeatureConfigCatalog);
        try {
            $gapicClient->updateGenerativeQuestionsFeatureConfig($generativeQuestionsFeatureConfig);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
