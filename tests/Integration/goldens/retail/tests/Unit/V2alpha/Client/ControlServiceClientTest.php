...
use Google\Cloud\Retail\V2alpha\Client\ControlServiceClient;
use Google\Cloud\Retail\V2alpha\Control;
use Google\Cloud\Retail\V2alpha\CreateControlRequest;
use Google\Cloud\Retail\V2alpha\DeleteControlRequest;
use Google\Cloud\Retail\V2alpha\GetControlRequest;
use Google\Cloud\Retail\V2alpha\ListControlsRequest;
use Google\Cloud\Retail\V2alpha\ListControlsResponse;
use Google\Cloud\Retail\V2alpha\UpdateControlRequest;
...
class ControlServiceClientTest extends GeneratedTest
{
    ...
    public function createControlTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.ControlService/CreateControl', $actualFuncCall);
    ...
    public function deleteControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ControlService/DeleteControl', $actualFuncCall);
    ...
    public function getControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ControlService/GetControl', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listControlsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ControlService/ListControls', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ControlService/UpdateControl', $actualFuncCall);
        $actualValue = $actualRequestObject->getControl();
        $this->assertProtobufEquals($control, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
