...
use Google\Cloud\Retail\V2alpha\AddControlRequest;
use Google\Cloud\Retail\V2alpha\Client\ServingConfigServiceClient;
use Google\Cloud\Retail\V2alpha\CreateServingConfigRequest;
use Google\Cloud\Retail\V2alpha\DeleteServingConfigRequest;
use Google\Cloud\Retail\V2alpha\GetServingConfigRequest;
use Google\Cloud\Retail\V2alpha\ListServingConfigsRequest;
use Google\Cloud\Retail\V2alpha\ListServingConfigsResponse;
use Google\Cloud\Retail\V2alpha\RemoveControlRequest;
use Google\Cloud\Retail\V2alpha\ServingConfig;
use Google\Cloud\Retail\V2alpha\UpdateServingConfigRequest;
...
class ServingConfigServiceClientTest extends GeneratedTest
{
    ...
    public function addControlTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.ServingConfigService/AddControl', $actualFuncCall);
    ...
    public function createServingConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ServingConfigService/CreateServingConfig', $actualFuncCall);
    ...
    public function deleteServingConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ServingConfigService/DeleteServingConfig', $actualFuncCall);
    ...
    public function getServingConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ServingConfigService/GetServingConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listServingConfigsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ServingConfigService/ListServingConfigs', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function removeControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ServingConfigService/RemoveControl', $actualFuncCall);
        $actualValue = $actualRequestObject->getServingConfig();
        $this->assertProtobufEquals($formattedServingConfig, $actualValue);
        $actualValue = $actualRequestObject->getControlId();
        $this->assertProtobufEquals($controlId, $actualValue);
    ...
    public function updateServingConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ServingConfigService/UpdateServingConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getServingConfig();
        $this->assertProtobufEquals($servingConfig, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
