...
use Google\Cloud\Retail\V2alpha\CreateModelRequest;
use Google\Cloud\Retail\V2alpha\DeleteModelRequest;
use Google\Cloud\Retail\V2alpha\GetModelRequest;
use Google\Cloud\Retail\V2alpha\ListModelsRequest;
use Google\Cloud\Retail\V2alpha\ListModelsResponse;
use Google\Cloud\Retail\V2alpha\Model;
use Google\Cloud\Retail\V2alpha\PauseModelRequest;
use Google\Cloud\Retail\V2alpha\ResumeModelRequest;
use Google\Cloud\Retail\V2alpha\TuneModelRequest;
use Google\Cloud\Retail\V2alpha\TuneModelResponse;
...
class ModelServiceClientTest extends GeneratedTest
{
    ...
    public function createModelTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/CreateModel', $actualApiFuncCall);
    ...
    public function deleteModelTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/DeleteModel', $actualFuncCall);
    ...
    public function getModelTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/GetModel', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listModelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/ListModels', $actualFuncCall);
    ...
    public function pauseModelTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/PauseModel', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function resumeModelTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/ResumeModel', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
    ...
    public function tuneModelTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/TuneModel', $actualApiFuncCall);
    ...
    public function updateModelTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ModelService/UpdateModel', $actualFuncCall);
