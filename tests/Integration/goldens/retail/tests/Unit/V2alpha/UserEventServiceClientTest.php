...
class UserEventServiceClientTest extends GeneratedTest
{
    ...
    public function exportUserEventsTest()
    {
        ...
        $incompleteOperation->setName('operations/exportUserEventsTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new ExportUserEventsResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/exportUserEventsTest');
        ...
        $response = $gapicClient->exportUserEvents($formattedParent, $outputConfig);
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.UserEventService/ExportUserEvents', $actualApiFuncCall);
        ...
        $expectedOperationsRequestObject->setName('operations/exportUserEventsTest');
