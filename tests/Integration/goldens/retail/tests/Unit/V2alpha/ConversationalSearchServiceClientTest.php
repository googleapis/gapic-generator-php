...
class ConversationalSearchServiceClientTest extends GeneratedTest
{
    ...
    public function conversationalSearchTest()
    {
        ...
        $serverStream = $gapicClient->conversationalSearch($placement, $formattedBranch, $visitorId);
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.ConversationalSearchService/ConversationalSearch', $actualFuncCall);
