 ...
 *
 * @param string $formattedParent Resource name of a
 ...
 */
function export_user_events_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        if ($response->operationSucceeded()) {
            /** @var ExportUserEventsResponse $result */
...
function callSample(): void
{
    ...
    export_user_events_sample($formattedParent);
}
