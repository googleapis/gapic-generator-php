 ...
 *
 * @param string $formattedParent Resource name of a [Branch][google.cloud.retail.v2alpha.Branch],
 ...
 */
function export_products_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        if ($response->operationSucceeded()) {
            /** @var ExportProductsResponse $result */
...
function callSample(): void
{
    ...
    export_products_sample($formattedParent);
}
