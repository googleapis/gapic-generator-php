 ...
 * requested project.
 *
 * @param string $formattedName Full LoggingConfig resource name. Format:
 *                              projects/{project_number}/loggingConfig
 *                              Please see {@see ProjectServiceClient::loggingConfigName()} for help formatting this field.
 */
function get_logging_config_sample(string $formattedName): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    get_logging_config_sample($formattedName);
}
