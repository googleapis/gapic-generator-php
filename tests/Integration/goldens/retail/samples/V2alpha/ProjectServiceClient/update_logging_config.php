 ...
 *
 * @param string $loggingConfigName Immutable. The name of the LoggingConfig singleton resource.
 *                                  Format: projects/&#42;/loggingConfig
 */
function update_logging_config_sample(string $loggingConfigName): void
{
    // Create a client.
...
{
    $loggingConfigName = '[NAME]';

    update_logging_config_sample($loggingConfigName);
}
