 ...
 * requested project.
 *
 * @param string $formattedName Full AlertConfig resource name. Format:
 *                              projects/{project_number}/alertConfig
 *                              Please see {@see ProjectServiceClient::alertConfigName()} for help formatting this field.
 */
function get_alert_config_sample(string $formattedName): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    get_alert_config_sample($formattedName);
}
