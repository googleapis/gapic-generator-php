 ...
 *
 * @param string $formattedName The name of the branch to retrieve.
 *                              Format:
 ...
 *                              default branch that has been set for the catalog. Please see
 *                              {@see BranchServiceClient::branchName()} for help formatting this field.
 */
function get_branch_sample(string $formattedName): void
{
    // Create a client.
...
{
    $formattedName = BranchServiceClient::branchName(
        '[PROJECT]',
        '[LOCATION]',
        '[CATALOG]',
        '[BRANCH]'
    ...
    get_branch_sample($formattedName);
}
