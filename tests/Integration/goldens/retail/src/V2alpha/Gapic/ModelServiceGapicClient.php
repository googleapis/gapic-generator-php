...
class ModelServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.cloud.retail.v2alpha.ModelService';
     ...
     * @param Model  $model        Required. The payload of the [Model][google.cloud.retail.v2alpha.Model]  to
     *                             create.
     ...
     * }
     *
     * @return \Google\Cloud\Retail\V2alpha\Model
     *
     * @throws ApiException if the remote call fails
     *
     * @experimental
     ...
     * ```
     *
     * @param Model $model        Required. The body of the updated
