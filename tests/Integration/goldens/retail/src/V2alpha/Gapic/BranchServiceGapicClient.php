 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/retail/v2alpha/branch_service.proto
...
use Google\Cloud\Retail\V2alpha\BranchView;
 ...
 * try {
 *     $formattedName = $branchServiceClient->branchName('[PROJECT]', '[LOCATION]', '[CATALOG]', '[BRANCH]');
 *     $response = $branchServiceClient->getBranch($formattedName);
 * } finally {
 *     $branchServiceClient->close();
 * }
 * ```
 *
 ...
 */
class BranchServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.retail.v2alpha.BranchService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/branch_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * ```
     *
     * @param string $name         Required. The name of the branch to retrieve.
     *                             Format:
     ...
     *           For allowed values, use constants defined on {@see \Google\Cloud\Retail\V2alpha\BranchView}
     ...
     * }
     *
     * @return \Google\Cloud\Retail\V2alpha\Branch
     *
     * @throws ApiException if the remote call fails
     *
     * @experimental
     */
    public function getBranch($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetBranch', Branch::class, $optionalArgs, $request)->wait();
    }
     ...
     * ```
     *
     * @param string $parent       Required. The parent catalog resource name.
     * @param array  $optionalArgs {
     *     Optional.
     *
     *     @type int $view
     ...
     * }
     *
     * @return \Google\Cloud\Retail\V2alpha\ListBranchesResponse
     *
     * @throws ApiException if the remote call fails
     *
     * @experimental
     */
    public function listBranches($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListBranches', ListBranchesResponse::class, $optionalArgs, $request)->wait();
    }
}
