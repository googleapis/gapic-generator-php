 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/retail/v2alpha/analytics_service.proto
...
class AnalyticsServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.cloud.retail.v2alpha.AnalyticsService';
