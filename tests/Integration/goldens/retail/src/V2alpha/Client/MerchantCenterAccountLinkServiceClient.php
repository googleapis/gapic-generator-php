 ...
 * @experimental
 *
 * @method PromiseInterface<OperationResponse> createMerchantCenterAccountLinkAsync(CreateMerchantCenterAccountLinkRequest $request, array $optionalArgs = [])
...
final class MerchantCenterAccountLinkServiceClient
{
     ...
     * @experimental
     */
    public static function merchantCenterAccountLinkName(string $project, string $location, string $catalog, string $merchantCenterAccountLink): string
    {
        return self::getPathTemplate('merchantCenterAccountLink')->render([
            'project' => $project,
            'location' => $location,
            'catalog' => $catalog,
     ...
     *           $options = new MerchantCenterAccountLinkServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see MerchantCenterAccountLinkServiceClient::createMerchantCenterAccountLinkAsync()}
     * .
     *
     * @example samples/V2alpha/MerchantCenterAccountLinkServiceClient/create_merchant_center_account_link.php
     *
     * @param CreateMerchantCenterAccountLinkRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return OperationResponse<MerchantCenterAccountLink>
     *
     * @throws ApiException Thrown if the API call fails.
     *
     * @experimental
     */
    public function createMerchantCenterAccountLink(CreateMerchantCenterAccountLinkRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateMerchantCenterAccountLink', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see MerchantCenterAccountLinkServiceClient::deleteMerchantCenterAccountLinkAsync()}
     * .
     *
     * @example samples/V2alpha/MerchantCenterAccountLinkServiceClient/delete_merchant_center_account_link.php
     *
     * @param DeleteMerchantCenterAccountLinkRequest $request     A request to house fields associated with the call.
     * @param array                                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function deleteMerchantCenterAccountLink(DeleteMerchantCenterAccountLinkRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteMerchantCenterAccountLink', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see MerchantCenterAccountLinkServiceClient::listMerchantCenterAccountLinksAsync()}
     * .
     *
     * @example samples/V2alpha/MerchantCenterAccountLinkServiceClient/list_merchant_center_account_links.php
     *
     * @param ListMerchantCenterAccountLinksRequest $request     A request to house fields associated with the call.
     * @param array                                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return ListMerchantCenterAccountLinksResponse
     *
     * @throws ApiException Thrown if the API call fails.
     *
     * @experimental
     */
    public function listMerchantCenterAccountLinks(ListMerchantCenterAccountLinksRequest $request, array $callOptions = []): ListMerchantCenterAccountLinksResponse
    {
        return $this->startApiCall('ListMerchantCenterAccountLinks', $request, $callOptions)->wait();
    }
}
