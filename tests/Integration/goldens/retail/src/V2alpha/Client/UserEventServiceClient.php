 ...
 * @method PromiseInterface<OperationResponse> exportUserEventsAsync(ExportUserEventsRequest $request, array $optionalArgs = [])
...
final class UserEventServiceClient
{
     ...
     *
     * @example samples/V2alpha/UserEventServiceClient/collect_user_event.php
     *
     ...
     *
     * The async variant is {@see UserEventServiceClient::exportUserEventsAsync()} .
     *
     * @example samples/V2alpha/UserEventServiceClient/export_user_events.php
     *
     * @param ExportUserEventsRequest $request     A request to house fields associated with the call.
     * @param array                   $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return OperationResponse<ExportUserEventsResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     *
     * @experimental
     */
    public function exportUserEvents(ExportUserEventsRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ExportUserEvents', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V2alpha/UserEventServiceClient/import_user_events.php
     *
     ...
     *
     * @example samples/V2alpha/UserEventServiceClient/purge_user_events.php
     *
     ...
     *
     * @example samples/V2alpha/UserEventServiceClient/rejoin_user_events.php
     *
     ...
     *
     * @example samples/V2alpha/UserEventServiceClient/write_user_event.php
     *
