 ...
 * @method PromiseInterface<BatchRemoveCatalogAttributesResponse> batchRemoveCatalogAttributesAsync(BatchRemoveCatalogAttributesRequest $request, array $optionalArgs = [])
...
final class CatalogServiceClient
{
     ...
     *
     * @example samples/V2alpha/CatalogServiceClient/add_catalog_attribute.php
     *
     ...
     * {@see CatalogServiceClient::batchRemoveCatalogAttributesAsync()} .
     *
     * @example samples/V2alpha/CatalogServiceClient/batch_remove_catalog_attributes.php
     *
     * @param BatchRemoveCatalogAttributesRequest $request     A request to house fields associated with the call.
     * @param array                               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function batchRemoveCatalogAttributes(BatchRemoveCatalogAttributesRequest $request, array $callOptions = []): BatchRemoveCatalogAttributesResponse
    {
        return $this->startApiCall('BatchRemoveCatalogAttributes', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V2alpha/CatalogServiceClient/get_attributes_config.php
     *
     ...
     *
     * @example samples/V2alpha/CatalogServiceClient/get_completion_config.php
     *
     ...
     *
     * @example samples/V2alpha/CatalogServiceClient/get_default_branch.php
     *
     ...
     *
     * @example samples/V2alpha/CatalogServiceClient/list_catalogs.php
     *
     ...
     * .
     *
     * @example samples/V2alpha/CatalogServiceClient/remove_catalog_attribute.php
     *
     ...
     * .
     *
     * @example samples/V2alpha/CatalogServiceClient/replace_catalog_attribute.php
     *
     ...
     *
     * @example samples/V2alpha/CatalogServiceClient/set_default_branch.php
     *
     ...
     * .
     *
     * @example samples/V2alpha/CatalogServiceClient/update_attributes_config.php
     *
     ...
     *
     * @example samples/V2alpha/CatalogServiceClient/update_catalog.php
     *
     ...
     * .
     *
     * @example samples/V2alpha/CatalogServiceClient/update_completion_config.php
     *
