 ...
 * @method PromiseInterface<OperationResponse> exportProductsAsync(ExportProductsRequest $request, array $optionalArgs = [])
...
final class ProductServiceClient
{
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/add_fulfillment_places.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/add_local_inventories.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/create_product.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/delete_product.php
     *
     ...
     *
     * The async variant is {@see ProductServiceClient::exportProductsAsync()} .
     *
     * @example samples/V2alpha/ProductServiceClient/export_products.php
     *
     * @param ExportProductsRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return OperationResponse<ExportProductsResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     *
     * @experimental
     */
    public function exportProducts(ExportProductsRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ExportProducts', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/get_product.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/import_products.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/list_products.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/purge_products.php
     *
     ...
     * .
     *
     * @example samples/V2alpha/ProductServiceClient/remove_fulfillment_places.php
     *
     ...
     * .
     *
     * @example samples/V2alpha/ProductServiceClient/remove_local_inventories.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/set_inventory.php
     *
     ...
     *
     * @example samples/V2alpha/ProductServiceClient/update_product.php
     *
