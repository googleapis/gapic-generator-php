...
final class BranchServiceClient
{
     ...
     *           $options = new BranchServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see BranchServiceClient::getBranchAsync()} .
     *
     * @example samples/V2alpha/BranchServiceClient/get_branch.php
     *
     * @param GetBranchRequest $request     A request to house fields associated with the call.
     ...
     * @experimental
     */
    public function getBranch(GetBranchRequest $request, array $callOptions = []): Branch
    {
        return $this->startApiCall('GetBranch', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see BranchServiceClient::listBranchesAsync()} .
     *
     * @example samples/V2alpha/BranchServiceClient/list_branches.php
     *
     * @param ListBranchesRequest $request     A request to house fields associated with the call.
     * @param array               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function listBranches(ListBranchesRequest $request, array $callOptions = []): ListBranchesResponse
    {
        return $this->startApiCall('ListBranches', $request, $callOptions)->wait();
    }
}
