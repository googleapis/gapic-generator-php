    ...
    'interfaces' => [
        'google.cloud.retail.v2alpha.CatalogService' => [
            'AddCatalogAttribute' => [
                ...
                'responseType' => 'Google\Cloud\Retail\V2alpha\AttributesConfig',
                'headerParams' => [
                    [
            ...
            'BatchRemoveCatalogAttributes' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\Retail\V2alpha\BatchRemoveCatalogAttributesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'attributes_config',
                        'fieldAccessors' => [
            ...
            'GetCompletionConfig' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\Retail\V2alpha\CompletionConfig',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
