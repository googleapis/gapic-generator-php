    ...
    'interfaces' => [
        'google.cloud.retail.v2alpha.ConversationalSearchService' => [
            'ConversationalSearch' => [
                'method' => 'post',
                'uriTemplate' => '/v2alpha/{placement=projects/*/locations/*/catalogs/*/placements/*}:conversationalSearch',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v2alpha/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:conversationalSearch',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
