    ...
    'interfaces' => [
        'google.cloud.retail.v2alpha.GenerativeQuestionService' => [
            'BatchUpdateGenerativeQuestionConfigs' => [
                'method' => 'post',
                'uriTemplate' => '/v2alpha/{parent=projects/*/locations/*/catalogs/*}/generativeQuestion:batchUpdate',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'GetGenerativeQuestionsFeatureConfig' => [
                'method' => 'get',
                'uriTemplate' => '/v2alpha/{catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature',
                'placeholders' => [
                    'catalog' => [
                        'getters' => [
                            'getCatalog',
            ...
            'ListGenerativeQuestionConfigs' => [
                'method' => 'get',
                'uriTemplate' => '/v2alpha/{parent=projects/*/locations/*/catalogs/*}/generativeQuestions',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
            ...
            'UpdateGenerativeQuestionConfig' => [
                'method' => 'patch',
                'uriTemplate' => '/v2alpha/{generative_question_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestion',
            ...
            'UpdateGenerativeQuestionsFeatureConfig' => [
                'method' => 'patch',
                'uriTemplate' => '/v2alpha/{generative_questions_feature_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature',
