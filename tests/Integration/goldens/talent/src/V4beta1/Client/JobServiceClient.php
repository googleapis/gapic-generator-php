 ...
 * @method PromiseInterface<void> batchDeleteJobsAsync(BatchDeleteJobsRequest $request, array $optionalArgs = [])
 ...
 * @method PromiseInterface<PagedListResponse> searchJobsAsync(SearchJobsRequest $request, array $optionalArgs = [])
...
final class JobServiceClient
{
     ...
     *
     * @example samples/V4beta1/JobServiceClient/batch_create_jobs.php
     *
     ...
     * }
     *
     * @return OperationResponse<JobOperationResult>
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/batch_delete_jobs.php
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/batch_update_jobs.php
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/create_job.php
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/delete_job.php
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/get_job.php
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/list_jobs.php
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/search_jobs.php
     *
     ...
     *
     * @example samples/V4beta1/JobServiceClient/search_jobs_for_alert.php
     *
     * @param SearchJobsRequest $request     A request to house fields associated with the call.
     * @param array             $callOptions {
     *     Optional.
     ...
     *
     * @example samples/V4beta1/JobServiceClient/update_job.php
     *
