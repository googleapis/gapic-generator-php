...
final class SpeechClient
{
     ...
     *
     * The async variant is {@see SpeechClient::longRunningRecognizeAsync()} .
     *
     * @example samples/V1/SpeechClient/long_running_recognize.php
     *
     ...
     * }
     *
     * @return OperationResponse<LongRunningRecognizeResponse>
     *
     ...
     *
     * @example samples/V1/SpeechClient/recognize.php
     *
     ...
     *
     * @example samples/V1/SpeechClient/streaming_recognize.php
     *
     * @param array $callOptions {
     *     Optional.
     *
