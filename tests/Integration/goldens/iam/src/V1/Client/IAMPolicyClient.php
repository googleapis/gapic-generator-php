...
namespace Google\Cloud\Iam\V1\Client;
...
final class IAMPolicyClient
{
     ...
     *           $options = new IAMPolicyClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * set.
     *
     * The async variant is {@see IAMPolicyClient::getIamPolicyAsync()} .
     *
     * @example samples/V1/IAMPolicyClient/get_iam_policy.php
     *
     ...
     *
     * The async variant is {@see IAMPolicyClient::setIamPolicyAsync()} .
     *
     * @example samples/V1/IAMPolicyClient/set_iam_policy.php
     *
     ...
     *
     * The async variant is {@see IAMPolicyClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/IAMPolicyClient/test_iam_permissions.php
     *
