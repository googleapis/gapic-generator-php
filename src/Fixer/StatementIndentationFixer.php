 ...
 * NOTICE
 *
 * This file has been copied from "friendsofphp/php-cs-fixer" (v3.11)
 *
 * Added to this library because we'd like to apply this fixer to a single snippet, but are
 * currently running v2.16. Upgrading to the latest version of php-cs-fixer would cause an excessive
...
namespace Google\Generator\Fixer;
            ...
            if (
                ...
                if ($token->isGivenKind([T_EXTENDS, T_IMPLEMENTS])) {
                    ...
                    if (isset($caseBlockStarts[$index])) {
                        ...
                        throw new \LogicException('missing AlternativeSyntaxAnalyzer');
                    }
