        ...
        $resumeOperation = AST::method('resumeOperation')
            ...
            ->withBody(AST::block(
                AST::assign($options, AST::nullCoalescing(
                    AST::access(AST::THIS, AST::property('descriptors'))[AST::nullCoalescing($methodName, AST::literal("''"))]['longRunning'],
                    $default
                )),
                ...
                PhpDoc::param($optionsParam, PhpDoc::block(
                    ...
                    PhpDoc::type(
                        ...
                        PhpDoc::text(
                            ...
                            PhpDoc::newLine(),
                            sprintf('use %s\\%s;', $this->serviceDetails->namespace, $this->serviceDetails->gapicClientV2Type->name),
                            PhpDoc::newLine(),
                            '$creds = new ServiceAccountCredentials($scopes, $json);',
                            PhpDoc::newLine(),
                            sprintf('$options = new %s([\'credentials\' => $creds]);', $this->serviceDetails->gapicClientV2Type->name),
                            PhpDoc::newLine(),
                            '```',
                            PhpDoc::newLine(),
