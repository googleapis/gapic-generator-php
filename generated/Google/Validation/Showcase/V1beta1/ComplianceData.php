...
class ComplianceData extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $f_bytes
     *     @type int $f_kingdom
     *     @type \Google\Validation\Showcase\V1beta1\ComplianceDataChild $f_child
     *     @type string $p_string
     *     @type int $p_int32
     *     @type float $p_double
     *     @type bool $p_bool
     *     @type int $p_kingdom
     *     @type \Google\Validation\Showcase\V1beta1\ComplianceDataChild $p_child
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Validation\Showcase\V1beta1\ComplianceData\LifeKingdom::class);
        $this->f_kingdom = $var;
    ...
    /**
     * Generated from protobuf field <code>.google.showcase.v1beta1.ComplianceDataChild f_child = 16;</code>
     * @return \Google\Validation\Showcase\V1beta1\ComplianceDataChild|null
     */
    ...
    /**
     * Generated from protobuf field <code>.google.showcase.v1beta1.ComplianceDataChild f_child = 16;</code>
     * @param \Google\Validation\Showcase\V1beta1\ComplianceDataChild $var
     * @return $this
     */
    public function setFChild($var)
    {
        GPBUtil::checkMessage($var, \Google\Validation\Showcase\V1beta1\ComplianceDataChild::class);
        $this->f_child = $var;
